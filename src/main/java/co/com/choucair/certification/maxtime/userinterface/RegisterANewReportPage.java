...
public class RegisterANewReportPage extends PageObject {
    ...
    public static final Target INPUT_COMMENT = Target.the("Items list that show de fields for the report").located(
            By.cssSelector(" td.HItem.NextColumn.GroupContent div + div + div + div +div + div +div + div input")
    );
